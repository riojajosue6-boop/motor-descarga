...
# --- DISEÑO PREMIUM UNIFICADO CON ADSENSE ---
HTML_PREMIUM = """
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="container">
        ...
        <div id="home-sec">
            <div class="main-card">
                ...
                <select id="formatInput" style="width:100%; padding:15px; margin-top:10px; border-radius:10px; background:#222; color:white; border:1px solid #444;">
        ...
        <div id="privacy-sec" class="legal-content">
            ...
            <p>En Motor de Descarga Pro, respetamos tu privacidad. No almacenamos registros personales ni videos procesados. Usamos cookies de Google AdSense para publicidad.</p>
        </div>
        ...
        async function processVideo() {
            ...
            try {
                ...
                if(data.success) {
                    ...
                    // LÓGICA DE DESCARGA: Usamos directamente la URL que envía el servidor
                    dBtn.onclick = () => { window.location.href = data.download_url; };
                } else { s.innerText = "❌ Error: La red social bloqueó el acceso o el link es inválido."; }
