...
def get_proxy():
    # Retorna el primer proxy (Francia) como principal
    user = proxy_users[0]
    return {
...
<body>
    ...
    <div class="container">
        <div id="home-sec">
            ...
            <div class="main-card">
                ...
                <div id="previewSection">
                    ...
                    <div id="supportBox">
                        🙏 <strong>Querido usuario:</strong> Apóyanos visitando las publicidades para mantener el servicio gratuito.
        ...
        <div id="privacy-sec" class="legal-content">
            ...
            <p>No almacenamos datos personales ni videos. Usamos cookies de AdSense para publicidad.</p>
        </div>
        <div id="terms-sec" class="legal-content">
            <h2>Términos y Condiciones</h2>
            <p>Uso personal y educativo. El usuario es responsable del contenido descargado.</p>
        </div>
    </div>
    ...
    <script>
        ...
        async function processVideo() {
            ...
            try {
                ...
                } else { s.innerText = "❌ No se pudo obtener información."; }
...
def api_info():
    ...
    try:
        ...
        # Usamos el proxy residencial para evitar bloqueos de la API
