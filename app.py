...
<body>
    <div class="container">
        <div class="main-card">
            ...
            <select id="formatInput" style="width:100%; padding:15px; border-radius:10px; background:#222; color:white; margin-bottom:20px;">
    ...
    <script>
        ...
        async function processVideo() {
            ...
            try {
                ...
                } else { s.innerText = "❌ Error de análisis."; }
